...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class KoinLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>viemodel</b> with <b>io.insert-koin:koin-androidx-compose</b> coordinates and
         * with version reference <b>koin</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getViemodel() {
            return create("koin.viemodel");
        }
    ...
    public static class KotlinSerializationLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>dep</b> with <b>org.jetbrains.kotlinx:kotlinx-serialization-json</b> coordinates and
         * with version reference <b>serial</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getDep() {
            return create("kotlin.serialization.dep");
        }

    }

    public static class KotlinxLibraryAccessors extends SubDependencyFactory {
        private final KotlinxKtorLibraryAccessors laccForKotlinxKtorLibraryAccessors = new KotlinxKtorLibraryAccessors(owner);

        public KotlinxLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>kotlinx.ktor</b>
         */
        public KotlinxKtorLibraryAccessors getKtor() {
            return laccForKotlinxKtorLibraryAccessors;
        }

    }

    public static class KotlinxKtorLibraryAccessors extends SubDependencyFactory {

        public KotlinxKtorLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>serilization</b> with <b>io.ktor:ktor-serialization-kotlinx-json</b> coordinates and
         * with version reference <b>ktor</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getSerilization() {
            return create("kotlinx.ktor.serilization");
        }
    ...
    public static class KtorLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>android</b> with <b>io.ktor:ktor-client-core</b> coordinates and
         * with version reference <b>ktor</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        ...
        /**
         * Dependency provider for <b>engine</b> with <b>io.ktor:ktor-client-okhttp</b> coordinates and
         * with version reference <b>ktor</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class MockLibraryAccessors extends SubDependencyFactory {
        private final MockAgentLibraryAccessors laccForMockAgentLibraryAccessors = new MockAgentLibraryAccessors(owner);

        public MockLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>instrumentation</b> with <b>io.mockk:mockk-android</b> coordinates and
         * with version reference <b>mockKVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getInstrumentation() {
            return create("mock.instrumentation");
        }

        /**
         * Dependency provider for <b>k</b> with <b>io.mockk:mockk</b> coordinates and
         * with version reference <b>mockKVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getK() {
            return create("mock.k");
        }

        /**
         * Group of libraries at <b>mock.agent</b>
         */
        public MockAgentLibraryAccessors getAgent() {
            return laccForMockAgentLibraryAccessors;
        }

    }

    public static class MockAgentLibraryAccessors extends SubDependencyFactory {

        public MockAgentLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>instrumentation</b> with <b>io.mockk:mockk-agent</b> coordinates and
         * with version reference <b>mockKVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getInstrumentation() {
            return create("mock.agent.instrumentation");
        }
    ...
    public static class TestLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>coroutine</b> with <b>org.jetbrains.kotlinx:kotlinx-coroutines-test</b> coordinates and
         * with version reference <b>coroutineTest</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCoroutine() {
            return create("test.coroutine");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>coroutineTest</b> with value <b>1.10.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>junitJupiter</b> with value <b>5.8.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>junitJupiterEngine</b> with value <b>5.10.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>mockKVersion</b> with value <b>1.13.17</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>serial</b> with value <b>1.8.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSerial() { return getVersion("serial"); }
    ...
    public static class BundleAccessors extends BundleFactory {
        ...
        /**
         * Dependency bundle provider for <b>junit5</b> which contains the following dependencies:
         * <ul>
         ...
         * This bundle was declared in catalog libs.versions.toml
         */
        public Provider<ExternalModuleDependencyBundle> getJunit5() {
            return createBundle("junit5");
        }
